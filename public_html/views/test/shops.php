...
<script>
    ...
    window.onscroll = function () {
        ...
        console.log(document.querySelector('#city_map').offsetHeight);
        console.log(aside.offsetHeight);
        console.log(OP);

        /*if (window.pageYOffset + document.querySelector('#city_map').offsetHeight > document.querySelector('#city_map').offsetHeight + aside.offsetHeight) {
            aside.className = 'stop';
            aside.style.top = (document.documentElement.scrollHeight - 600 - aside.offsetHeight - OP) + 'px';
        } else {
            aside.style.top = '0';
...
<script type="text/javascript">
    ...
    function changeMap(adress, name, shop_id) {
        ...
        $('.card-header').html('<strong>' + name + '</strong> - ' + adress);
